...
{
    public class AdditionalServiceReservationConfiguration : IEntityTypeConfiguration<AdditionalServiceReservationEntity>
    {
        public void Configure(EntityTypeBuilder<AdditionalServiceReservationEntity> builder)
        {
